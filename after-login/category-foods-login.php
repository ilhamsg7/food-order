        ...
        <div class="topnav" id="myTopnav">
            <div class="top" style="text-align: right;">
                <img src="../images/Resto Dark 2.png" alt="Restaurant Logo" class="item a images">
                    <a class="item a" href="<?php echo SITEURL;?>after-login/index-login.php">Home</a>
                    <a class="item a" href="<?php echo SITEURL;?>after-login/status_order-login.php">Ordered Status</a>
                    <a class="item a cart" href="<?php echo SITEURL;?>after-login/cart-index.php"><i class="fa fa-shopping-cart"></i></a>
                    <a class="item a" href="<?php echo SITEURL;?>after-login/customer-login.php">Logout</a>
