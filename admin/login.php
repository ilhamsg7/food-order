        ...
        <section class="Form" style="height: 100vh;">
            <div class="container-fluid">
                <div class="row" style="height: 100vh;">
                    <div class="col-lg-7 tengah" style="background-color:#DA0037;">
                    ...
                    <div class="col-lg-5 px-5 kanan-tengah" data-aos="fade-up" data-aos-duration="1200">
                            <img src="../images/Resto Light.png" style="height: 200px;" class="gambar1 mb-3">
                            <?php
